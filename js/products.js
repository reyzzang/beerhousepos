...
export const categories = [
  {
    ...
    items: [
      ...
      { id: 'lowenbrau', name: 'LÖWENBRÄU', price: 5.80, unit: 'ლიტრი', type: 'liter', multipliers: [1, 2, 3, 6] },
      { id: 'staropramen', name: 'Staropramen', price: 6.00, unit: 'ლიტრი', type: 'liter', multipliers: [1, 2, 3, 6] },
      { id: 'alpenbrau', name: 'ALPENBRÄU', price: 4.00, unit: 'ლიტრი', type: 'liter', multipliers: [1, 2, 3, 6] },
